...
//		});
	...
	this.initResources = function ()
	{
		...
		{
			// SSM: Add start and end date in order to retrieve relevant reservations
                        $(this).bindResourceDetails($(this).attr('resourceId'), $(this).attr('startdate'), $(this).attr('enddate'));
		});
	};
