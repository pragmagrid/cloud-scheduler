...
interface IResourceService
{
	...
	public function GetResourceAttributes();
        ...
        /**
	 * SSM: Get all resource attributes
	 *
         * @return Attribute[]
         */
        public function GetResourceAttributeValues( $resourceIds );
...
class ResourceService implements IResourceService
{
	...
	public function GetResourceAttributeValues( $resourceIds )
	{
		return $this->_attributeService->GetAttributes(CustomAttributeCategory::RESOURCE, $resourceIds);
	}
