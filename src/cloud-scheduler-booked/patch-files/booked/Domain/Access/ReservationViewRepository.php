...
class ReservationView
{
	...
	/* reservation status: true if PCC status is starting */
	public function IsStarting()
	{
		return $this->StatusId == ReservationStatus::Starting;
	}

	/* reservation status: true if PCC status is running */
	public function IsRunning()
	{
		return $this->StatusId == ReservationStatus::Running;
	}

	/* reservation status: true if PCC status is stopping */
	public function IsStopping()
	{
		return $this->StatusId == ReservationStatus::Stopping;
	}
...
class ReservationItemView implements IReservedItemView
{
	...
	/* variables for PCC reservation status */
	public $ReservationStarting;
	public $ReservationRunning;
	public $ReservationStopping;
	...
	public static function Populate($row)
	{
		...
		if (isset($row[ColumnNames::RESERVATION_STATUS]))
		{
			...
			$view->ReservationStarting = $row[ColumnNames::RESERVATION_STATUS] == ReservationStatus::Starting;
			$view->ReservationRunning = $row[ColumnNames::RESERVATION_STATUS] == ReservationStatus::Running;
			$view->ReservationStopping = $row[ColumnNames::RESERVATION_STATUS] == ReservationStatus::Stopping;
		}
