...
class SchedulePresenter extends ActionPresenter implements ISchedulePresenter {
	...
	/* SSM: (Begin): Get Resource attribute values */
	$resourceIds = array();
        foreach( $resources as $resource ) {
		array_push( $resourceIds, $resource->Id );
	}
	$resourceAttributeValues = $this->_resourceService->GetResourceAttributeValues($resourceIds);
	$this->_page->Set('ResourceAttributeValueList', $resourceAttributeValues );
	/* SSM: (End) Get Resource attribute values */
