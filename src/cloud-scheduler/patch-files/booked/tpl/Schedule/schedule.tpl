...
{function name=displayGeneralReserved}
	...
	{/if}
 	{if $Slot->IsStarting()}
		{assign var=class value='starting'}
       	{/if}
       	{if $Slot->IsRunning()}
		{assign var=class value='running'}
       	{/if}
       	{if $Slot->IsStopping()}
		{assign var=class value='stopping'}
       	{/if}
...
-->
	...
	<div class="legend reserved starting">{translate key=Starting}</div>
	<div class="legend reserved running">{translate key=Running}</div>
	<div class="legend reserved stopping">{translate key=Stopping}</div>
<!--
