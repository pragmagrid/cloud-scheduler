...
class SlotLabelFactory
{
	 ...
	 * @return string
	 */
	public static function Create($reservations)
	{
		$f = new SlotLabelFactory();
		return $f->Format($reservations);
	}
	 ...
	 * @return string
	 */
	public function Format($reservations, $format = null)
	{
		if (empty($format))
		{
		...
		$labels = array();
		// SSM: iterate over all reservations
